		...
		extend: {
			...
			keyframes: {
				...
				'glowPulse': {
					...
					'50%': {
						boxShadow: '0 0 30px rgba(59, 130, 246, 0.8), 0 0 40px rgba(147, 51, 234, 0.6)'
					}
				},
				'gradient-flow': {
					'0%': {
				...
				'luxury-glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px rgba(255, 193, 7, 0.4), 0 0 40px rgba(255, 165, 0, 0.2)',
						transform: 'scale(1)'
					},
					'50%': {
						boxShadow: '0 0 30px rgba(255, 193, 7, 0.6), 0 0 60px rgba(255, 165, 0, 0.4), 0 0 80px rgba(255, 140, 0, 0.2)',
			...
			animation: {
				...
				'luxury-glow': 'luxury-glow 12s ease-in-out infinite',
				'luxury-glow-slow': 'luxury-glow 12s ease-in-out infinite'
			}
		}
	},
