    ...
    <section className="min-h-screen flex items-center relative overflow-hidden w-full h-full">
      ...
      <div className="w-full px-0 sm:px-4 md:px-6 lg:px-8 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Sub Headline */}
          <p className="text-base sm:text-lg md:text-2xl lg:text-3xl text-white/90 mb-6 sm:mb-16 leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
            비전공자도 AI와 함께하는 바이브 코딩으로<br />
            <span className="text-accent font-semibold">MVP부터 포트폴리오까지</span>
          </p>

          {/* Key Values */}
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-8 mb-6 sm:mb-16 animate-slide-up" style={{ animationDelay: '0.4s' }}>
